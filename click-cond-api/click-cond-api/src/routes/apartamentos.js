...
const router = Router();
const controller = require('../controller/ControllerApartamento');
const jwt = require('../middlewares/jwtVerify.js');
const validate = require('../validations/ValidationApartamento.js');
...
router.get('/get-moradores', jwt({ typeAccess: ['Sindico', 'Morador', 'Funcionario'] }), controller.getMoradores);
